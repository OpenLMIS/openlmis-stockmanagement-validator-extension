...
public abstract class MessageKeys {
  ...
  private static final String EXTENSION_EVENT_ERROR_PREFIX = EVENT_ERROR_PREFIX + ".extension";
  ...
  public static final String ERROR_REASON_FREE_TEXT_NOT_ALLOWED_EXTENSION =
      EXTENSION_EVENT_ERROR_PREFIX + ".reasonFreeText.notAllowed";
  ...
  public static final String ERROR_EVENT_ADJUSTMENT_REASON_CATEGORY_INVALID_EXTENSION =
      EXTENSION_EVENT_ERROR_PREFIX + ".adjustment.reason.category.invalid";
  ...
  public static final String ERROR_EVENT_CANNOT_UNPACK_REGULAR_ORDERABLE_EXTENSION =
      EXTENSION_EVENT_ERROR_PREFIX + ".cannot.unpack.orderable.not.kit";
